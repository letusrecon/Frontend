      ...
      <div id="features" className={styles.service_main_wrap}>
        ...
        <div className={styles.service_flex_container}>
          ...
          <div className={styles.service_inner_container}>
            ...
            <p className={styles.service_inner_container_desc}>
              Receive comprehensive reports on potential weaknesses, enabling
              you to proactively find and report vulnerabilities in the systems
              and applications of your target.
            </p>
          </div>
          <div className={styles.service_inner_container}>
        ...
        <div className={styles.service_flex_container}>
          ...
          <div className={styles.service_inner_container}>
            ...
            <p className={styles.service_inner_container_desc}>
              Optimise your reconnaissance process with an integrated toolkit
              for subdomain enumeration, directory brute-forcing, and concealed
              parameter detection.
            </p>
          </div>
          <div className={styles.service_inner_container}>
            ...
            <p className={styles.service_inner_container_desc}>
              plans with exceptional service, tailored for users.
              Round-the-clock support ensures you receive the help you need when
