...
export default function Footer() {
  ...
  return (
    <div className=" bg-[#3D3E3D] flex flex-col sm:flex-col md:flex-row lg:flex-row justify-end px-6 py-5">
      
        <div className="text-center sm:mb-3 mb-3 md:mb-0 lg:mb-0 text-slate-200 mr-9">
          <p className='text-md'>{FooterDate()} LetUsRecon - All Rights Reserved</p>
        </div>
