        ...
        <div className="px-5 py-8 md:px-8 md:py-5 lg:py-5 lg:px-10">
          ...
          <div className="grid  lg:grid-cols-3 sm:grid-cols-1 lg:py-5 px-2 lg:gap-9 text-sm">
            ...
            <div className="bg-[#141C1D] sm:mb-4 md:mb-0 mb-4 lg:mb-0 rounded-xl border border-[#3A4245] text-white text-center p-5">
              ...
              <h3 className="mb-10">
                A tool that helps discover subdomains from IP ranges by
                performing DNS resolution and collecting all subdomains
                associated with the IPs in the specific range.
              </h3>
              {/* button */}
              <div className="m-4">
            ...
            <div className="bg-[#141C1D] sm:mb-4 md:mb-0 mb-4 lg:mb-0 rounded-xl border border-[#3A4245] text-white text-center p-5">
              ...
              <h3 className="mb-10">
                Basic tool which provides a straightforward solution for
                bypassing 403 restriction on endpoints, allowing users to access
                them with ease.
              </h3>
              {/* button */}
              <div className="m-4">
            ...
            <div className="bg-[#141C1D] sm:mb-4 md:mb-0 mb-4 lg:mb-0 rounded-xl border border-[#3A4245] text-white text-center p-5">
              ...
              <h3 className="">
                Discover hidden directories and file with a directory
                brute-force tool that expands your attack surface and reveal
                restricted resources and uncover potential vulnerabilities.
              </h3>
              {/* button */}
              <div className="m-4">
            ...
            <div className="bg-[#141C1D] sm:mb-4 md:mb-0 mb-4 lg:mb-0 rounded-xl border border-[#3A4245] text-white text-center p-5">
              ...
              <h3 className="mb-8">
                Discover hidden admin panels and login pages on the target
                domain with this easy-to-use tool for better reconnaissance and
                accessing potential vulnerable login panels.
              </h3>
              {/* button */}
              <div className="m-4">
            ...
            <div className="bg-[#141C1D] sm:mb-4 md:mb-0 mb-4 lg:mb-0 rounded-xl border border-[#3A4245] text-white text-center p-4">
              ...
              <h3 className="">
                ...
                misconfigurations that could allow an attacker to take control
                of a subdomain and potentially compromise your entire domain.
              </h3>
              {/* button */}
              <div className="m-4">
            ...
            <div className="bg-[#141C1D] sm:mb-4 md:mb-0 mb-4 lg:mb-0 rounded-xl border border-[#3A4245] text-white text-center p-4">
              ...
              <h3 className="mb-9">
                ...
                attack surface and uncover potential vulnerabilities suitable
                for wild-scope targets.
              </h3>
              {/* button */}
              <div className="m-4">
            ...
            <div className="bg-[#141C1D] sm:mb-4 md:mb-0 mb-4 lg:mb-0 rounded-xl border border-[#3A4245] text-white text-center p-4">
              ...
              <h3 className="">
                ...
                used to identify configuration files that may reveal details
                about the target's infrastructure or applicationstack.
              </h3>
              {/* button */}
              <div className="m-4">
